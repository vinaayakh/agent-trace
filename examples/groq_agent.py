"""ReAct-style agent demo using the Groq SDK.

Groq exposes an OpenAI-compatible API, so the only difference from the
OpenAI example is the client import and the model name. agent_trace needs
no changes — the httpx interceptor already recognises api.groq.com.

Run:
    export GROQ_API_KEY=gsk_...
    python examples/groq_agent.py

Free-tier Groq keys are available at https://console.groq.com
Model options: llama-3.1-8b-instant, llama3-70b-8192, mixtral-8x7b-32768
"""
...
if __name__ == "__main__":
    agent_trace.init(service_name="groq-agent-demo")
